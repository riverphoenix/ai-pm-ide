...
export default function InsightsPanel({ projectId, apiKey, onNavigateToFramework, onClose }: InsightsPanelProps) {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const response = await fetch('http://127.0.0.1:8000/insights/generate', {
        method: 'POST',
  ...
  return (
    <div className="fixed right-0 top-0 bottom-0 w-80 bg-codex-bg border-l border-codex-border shadow-xl z-40 flex flex-col">
